  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-4xl mx-auto p-6 bg-black border border-white rounded-2xl shadow md space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <input className="input bg-black text-white" name="name" placeholder="Full Name" onChange={handleChange} />
        <input className="input" name="age" type="number" placeholder="Age" onChange={handleChange} />
        <select className="input bg-black text-white" name="gender" onChange={handleChange}>
      ...
      <textarea className="input" name="primarySymptom" placeholder="Primary Symptom" onChange={handleChange} />
      <textarea className="input" name="additionalSymptoms" placeholder="Additional Symptoms (comma separated)" onChange={handleChange} />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <select className="input bg-black text-white" name="severity" onChange={handleChange}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <input className="input" name="temperature" placeholder="Temperature (if known)" onChange={handleChange} />
      </div>
